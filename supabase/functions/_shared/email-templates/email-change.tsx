...
export const EmailChangeEmail = ({
  ...
  <Html lang="ro" dir="ltr">
    <Head />
    <Preview>Confirmă schimbarea adresei de email - IsoftGlass ERP</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          Ai solicitat schimbarea adresei de email pentru contul tău IsoftGlass ERP de la{' '}
        ...
        <Text style={text}>
          Apasă butonul de mai jos pentru a confirma:
        </Text>
        <Button style={button} href={confirmationUrl}>
          Confirmă schimbarea
        </Button>
        <Text style={footer}>
          Dacă nu ai solicitat această modificare, securizează-ți contul imediat.
        </Text>
...
const link = { color: '#171d2d', textDecoration: 'underline' }
const button = {
